...
##################################################################################################
##################################################################################################
#########               ASSIGNMENT INFO - FIRST 130 LINES                 ########################
##################################################################################################
##################################################################################################
##################################################################################################
...
##  the mean, especially if it has to be computed repeatedly (e.g. in a loop). If the contents 
##  of a vector are not changing, it may make sense to cache the value of the mean so that when 
##  we need it again, it can be looked up in the cache rather than recomputed. In this 
##  Programming Assignment will take advantage of the scoping rules of the R language and how 
...
##  Clone your forked GitHub repository to your computer so that you can edit the files 
##  locally on your own machine.

##  Edit the R file contained in the git repository and place your solution in that file 
##  (please do not rename the file).

##  Commit your completed R file into YOUR git repository and push your git branch to the 
##  GitHub repository under your account.

##  Submit to Coursera the URL to your GitHub repository that contains the completed 
##  R code for the assignment.

##  In addition to submitting the URL for your GitHub repository, you will need to submit 
##  the 40 character SHA-1 hash (as string of numbers from 0-9 and letters from a-f) 
##  that identifies the repository commit that contains the version of the files 
##  you want to submit. You can do this in GitHub by doing the following
    ##  Going to your GitHub repository web page for this assignment
    ##  Click on the "?? commits" link where ?? is the number of commits you have in the 
    ##  repository. For example, if you made a total of 10 commits to this repository, the 
    ##  link should say "10 commits".

    ##  You will see a list of commits that you have made to this repository. The most recent 
    ##  commit is at the very top. If this represents the version of the files you want to 
    ##  submit, then just click the "copy to clipboard" button on the right hand side that 
    ##  should appear when you hover over the SHA-1 hash. Paste this SHA-1 hash into the 
    ##  course web site when you submit your assignment. If you don't want to use the most 
...
makeCacheMatrix <- function(x = matrix()) 
{
  ...
  setInverse <- function(inverse) cachedInverseofMatrix <<- inverse
